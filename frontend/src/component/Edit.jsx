      ...
      try {
        if (blogId) {
          const response = await axios.get(
            `https://blog-cards.up.railway.app/edit/${blogId}` || `http://localhost:3000/edit/${blogId}`
          );
  ...
  const handleupdate = async () => {
    try {
      ...
      const response = await axios.patch(
        `https://blog-cards.up.railway.app/update/${blogID}` || `http://localhost:3000/update/${blogID}`,
